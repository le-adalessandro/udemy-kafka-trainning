...
public class LibraryEventControllerUnitTest {
	...
	public void updateLibraryEvent() throws Exception {
		...
		final MockHttpServletRequestBuilder request = put("/v1/libraryevent").content(
				json)
				.contentType(MediaType.APPLICATION_JSON);
		...
		mockMvc.perform(request).andExpect(status().isOk()).andExpect(content().string(expectedRecord));
	}
	...
	public void updateLibraryEvent_withNullLibraryEventId() throws Exception {
		...
		final String expectedErrorMessage = "{\"Message\": \"Please pass the LibraryEventId\"}";
		mockMvc.perform(request).andExpect(status().is4xxClientError())
				.andExpect(content().string(expectedErrorMessage));
	}

	@Test
	public void putLibraryEvent_shouldFail_whenNullBook() throws Exception {

		final LibraryEvent libraryEvent = LibraryEvent.builder().libraryEventId(123).book(null).build();
	...
	@Test
	public void putLibraryEvent_shouldFail_whenEmptyBok() throws Exception {

		final LibraryEvent libraryEvent = LibraryEvent.builder().libraryEventId(123).book(new Book()).build();
